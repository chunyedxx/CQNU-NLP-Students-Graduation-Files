...
class TestDataLoader(object):
	...
	def read(self):
		...
		# print("self.relTotal",self.relTotal)
		# print("self.entTotal", self.entTotal)
		# print("self.testTotal", self.testTotal)
	...
	def sampling_lp(self):
		...
		# print(self.test_h.copy(),self.test_t[:1].copy(),self.test_r[:1].copy())
